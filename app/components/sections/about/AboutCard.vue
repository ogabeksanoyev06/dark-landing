<template>
	<div ref="cardRef" class="flex flex-col gap-4 lg:gap-0 md:flex-row max-w-[1184px] w-full mx-auto lg:mt-[70px]">
		<div
			class="card-1 flex flex-col gap-6 md:flex-1 md:basis-0 bg-black rounded-[32px] lg:rounded-l-[48px] lg:rounded-r-none h-auto lg:h-[330px] px-7 py-8 lg:px-10 lg:py-11 relative z-[5] overflow-hidden"
		>
			...
			<NuxtImg src="/images/about-card-bg.webp" alt="decor" class="absolute inset-0 h-full w-full z-[-1]" />
		</div>
		...
		<div
			class="card-3 flex flex-col gap-6 md:flex-1 md:basis-0 bg-black rounded-[32px] lg:rounded-r-[48px] lg:rounded-l-none h-auto lg:h-[330px] px-7 py-8 lg:px-10 lg:py-11 relative z-[5] overflow-hidden"
		>
